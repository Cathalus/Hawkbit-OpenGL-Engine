...
void UniformManager::uploadUniformData(Shader shader)
{
...
void UniformManager::updateUniformData(std::string uniformName, glm::mat4& mat)
{
	_mat4[uniformName] = mat;
}

void UniformManager::updateUniformData(std::string uniformName, glm::mat3& mat)
{
	_mat3[uniformName] = mat;
}

void UniformManager::updateUniformData(std::string uniformName, glm::vec4& mat)
{
	_vec4[uniformName] = mat;
}

void UniformManager::updateUniformData(std::string uniformName, glm::vec3& mat)
{
	_vec3[uniformName] = mat;
}

void UniformManager::updateUniformData(std::string uniformName, glm::vec2& mat)
{
	_vec2[uniformName] = mat;
}

void UniformManager::updateUniformData(std::string uniformName, float f)
{
	_float[uniformName] = f;
}

void UniformManager::updateUniformData(std::string uniformName, unsigned int ui)
{
	_uint[uniformName] = ui;
}

void UniformManager::updateUniformData(std::string uniformName, int i)
{
	_int[uniformName] = i;
}
